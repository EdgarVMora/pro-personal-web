  ...
  return (
    ...
    >
      <div style={{ maxWidth: '560px' }}>
        ...
        {/* Label badge */}
        <div className="contact-anim flex items-center gap-3 mb-6">
        ...
        {/* Heading */}
        <h2 className="contact-anim font-display text-title text-foreground mb-4">
          ¿Trabajamos juntos?
        </h2>

        {/* Subtext */}
        <p className="contact-anim font-sans text-lg leading-relaxed text-muted mb-10">
        ...
        <a
          ...
          className="contact-anim block font-display text-2xl text-foreground hover:text-accent hover:glow-amber-text transition-all duration-300 mb-10"
        >
          {personal.email}
        </a>

        {/* Social links */}
        <div className="contact-anim flex gap-4">
          <a
